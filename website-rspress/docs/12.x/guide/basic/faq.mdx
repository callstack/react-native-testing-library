...
The [User Event interactions](api/events/user-event) solve some of the simulation issues, as they offer more realistic event handling than the basic [Fire Event API](fire-event).
...
We encourage you to migrate existing tests to use the [User Event interactions](api/events/user-event), which offer more realistic event handling than the basic [Fire Event API](fire-event). Hence, it will provide more confidence in the quality of your code.
