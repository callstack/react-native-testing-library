...
const queryAllByText = (instance: HostComponent): QueryAllByQuery<TextMatch, ByTextOptions> =>
...
export const bindByTextQueries = (instance: HostComponent): ByTextQueries => ({
