...
```sh [npm]
npm install -D @testing-library/react-native@next
```

```sh [yarn]
yarn add -D @testing-library/react-native@next
```

```sh [pnpm]
pnpm add -D @testing-library/react-native@next
```

```sh [bun]
bun add -D @testing-library/react-native@next
```
