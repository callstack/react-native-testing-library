...
Test Renderer is automatically managed as a dependency of React Native Testing Library. RNTL v14 requires React 19 and React Native 0.78+. If you need React 18 support, please use RNTL v13.x.
