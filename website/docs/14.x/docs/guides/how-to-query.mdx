...
| [`queryAllBy*`](docs/api/queries#query-all-by) | No assertion                  | `Array<HostElement>`                 | No        |
| [`findBy*`](docs/api/queries#find-by)          | Exactly one matching element  | `Promise<HostElement>`               | Yes       |
| [`findAllBy*`](docs/api/queries#find-all-by)   | At least one matching element | `Promise<Array<HostElement>>`        | Yes       |
