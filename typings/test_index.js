...
const View = (props: any) => props.children;
const Text = (props: any) => props.children;
const TextInput = (props: any) => props.children;
...
const waitGetBy: Promise<ReactTestInstance>[] = [
  waitFor<ReactTestInstance>(() => tree.getByLabelText('label')),
  waitFor<ReactTestInstance>(() => tree.getByLabelText('label'), timeout),
...
const waitGetAllBy: Promise<ReactTestInstance[]>[] = [
  waitFor<ReactTestInstance[]>(() => tree.getAllByLabelText('label')),
  waitFor<ReactTestInstance[]>(() => tree.getAllByLabelText('label'), timeout),
  waitFor<ReactTestInstance[]>(
    () => tree.getAllByLabelText('label'),
    timeoutInterval
  ),
